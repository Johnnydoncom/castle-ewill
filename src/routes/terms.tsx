...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Service — Castle eWill & Trust" },
      { name: "description", content: "The terms and conditions that govern your use of Castle eWill & Trust." },
      { property: "og:title", content: "Castle Terms" },
